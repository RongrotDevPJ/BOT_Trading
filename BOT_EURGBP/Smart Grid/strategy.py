...
class SmartGridStrategy:
    ...
    def check_grid_logic(self, executor, current_atr):
        ...
        # Process Buy Grid
        if buy_positions:
            if self.needs_new_grid_level(buy_positions, current_ask, side=0, current_atr=current_atr):
        ...
        # Process Sell Grid
        if sell_positions:
             if self.needs_new_grid_level(sell_positions, current_bid, side=1, current_atr=current_atr):
