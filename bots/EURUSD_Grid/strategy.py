...
class SmartGridStrategy:
    ...
    def calculate_dynamic_lot(self, current_equity):
        ...
        lot_per_unit = config.BASE_LOT / config.BASE_EQUITY   # e.g. 0.10 / 5000 = 0.00002 lots/$
        lot_raw      = current_equity * adjusted_pct / (1.0 / lot_per_unit)
        # Simplified: lot_raw = current_equity * adjusted_pct * lot_per_unit
