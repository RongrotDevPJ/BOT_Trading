# --- Bot Configuration ---
SYMBOL = "XAUUSD"
MAGIC_NUMBER = 222222 # Different from EURUSD
...
# --- Smart Grid Settings ---
GRID_DISTANCE_POINTS = 700 # Base distance fallback
...
RSI_PERIOD = 14
RSI_BUY_LEVEL = 30  # Strict oversold level
RSI_SELL_LEVEL = 70 # Strict overbought level
...
# --- Risk Management ---
MAX_ALLOWED_SPREAD = 60 # Gold Spread Guard limit (Updated)
...
COOLDOWN_MINUTES = 20 # Wait at least 20 min between grid levels (Gold is volatile)
